        ...
        <div className="w-[527px] flex flex-col items-center justify-center gap-[35px] px-[20px]">
          <div className="w-full flex flex-col items-center justify-center gap-[10px]">
            ...
            <p className="text-[#111111]/80 font-normal text-[13px]">
              Craft your professional identity and stand out.
            </p>
          </div>
          ...
          <div className="w-full flex flex-col gap-[10px]">
            ...
            <input
              ...
              required
              placeholder="Ex: Student | Web Developer | Freelancer"
              className="rounded-[10px] py-[14px] w-full px-[33px] bg-[#111111]/5 border-none outline-none focus:brightness-75"
            />
          </div>
          <div className="w-full">
            <button
              ...
              type="submit"
              className="flex justify-center items-center border-2 border-[#111111] bg-[#111111] text-white rounded-[10px] py-[14px] w-full"
            >
              Complete
            </button>
          </div>
...
export default RigisterIndividual;
